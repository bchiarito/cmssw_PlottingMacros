...
#ifdef MyClassMC_cxx
MyClassMC::MyClassMC(TTree *tree) : fChain(0) 
{
...
Int_t MyClassMC::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t MyClassMC::LoadTree(Long64_t entry)
{
...
void MyClassMC::Init(TTree *tree)
{
...
void MyClassMC::Show(Long64_t entry)
{
...
Int_t MyClassMC::Cut(Long64_t entry)
{
