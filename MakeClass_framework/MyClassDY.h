...
// Mon Nov 19 11:32:03 2018 by ROOT version 6.06/01
// from TTree fTree2/ChargedDecayTree
// found on file: /cms/chiarito/eos/twoprong/ztagandprobe/Nov17_trees/DY/DYJetsToLL_M-50_TuneCUETP8M1_13TeV-madgraphMLM-pythia8/DY_50_ext1_signal_MuonHadronicFilter/181118_030641/0000/TwoProngNtuplizer_1.root
//////////////////////////////////////////////////////////
...
// Fixed size dimensions of array or collections stored in the TTree if any.
   ...
   Double_t        mcW;
   Double_t        mcWProd;
   Double_t        tauDecayType;
   vector<double>  *GenTau_pt;
   vector<double>  *GenTau_eta;
   vector<double>  *GenTau_phi;
   vector<double>  *GenTau_mass;
   vector<double>  *GenTau_objDR;
   vector<double>  *GenTau_candobjDR;
   Int_t           HLT_Photon175;
   ...
   TBranch        *b_mcW;   //!
   TBranch        *b_mcWProd;   //!
   TBranch        *b_tauDecayType;   //!
   TBranch        *b_GenTau_pt;   //!
   TBranch        *b_GenTau_eta;   //!
   TBranch        *b_GenTau_phi;   //!
   TBranch        *b_GenTau_mass;   //!
   TBranch        *b_GenTau_objDR;   //!
   TBranch        *b_GenTau_candobjDR;   //!
...
#ifdef MyClassDY_cxx
MyClassDY::MyClassDY(TTree *tree) : fChain(0) 
{
// if parameter tree is not specified (or zero), connect the file
// used to generate this class and read the Tree.
   if (tree == 0) {
      TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("/cms/chiarito/eos/twoprong/ztagandprobe/Nov17_trees/DY/DYJetsToLL_M-50_TuneCUETP8M1_13TeV-madgraphMLM-pythia8/DY_50_ext1_signal_MuonHadronicFilter/181118_030641/0000/TwoProngNtuplizer_1.root");
      if (!f || !f->IsOpen()) {
         f = new TFile("/cms/chiarito/eos/twoprong/ztagandprobe/Nov17_trees/DY/DYJetsToLL_M-50_TuneCUETP8M1_13TeV-madgraphMLM-pythia8/DY_50_ext1_signal_MuonHadronicFilter/181118_030641/0000/TwoProngNtuplizer_1.root");
      }
      TDirectory * dir = (TDirectory*)f->Get("/cms/chiarito/eos/twoprong/ztagandprobe/Nov17_trees/DY/DYJetsToLL_M-50_TuneCUETP8M1_13TeV-madgraphMLM-pythia8/DY_50_ext1_signal_MuonHadronicFilter/181118_030641/0000/TwoProngNtuplizer_1.root:/twoprongNtuplizer");
...
Int_t MyClassDY::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t MyClassDY::LoadTree(Long64_t entry)
{
...
void MyClassDY::Init(TTree *tree)
{
   ...
   fChain->SetBranchAddress("tauDecayType", &tauDecayType, &b_tauDecayType);
   ...
   fChain->SetBranchAddress("GenTau_objDR", &GenTau_objDR, &b_GenTau_objDR);
   fChain->SetBranchAddress("GenTau_candobjDR", &GenTau_candobjDR, &b_GenTau_candobjDR);
...
void MyClassDY::Show(Long64_t entry)
{
...
Int_t MyClassDY::Cut(Long64_t entry)
{
